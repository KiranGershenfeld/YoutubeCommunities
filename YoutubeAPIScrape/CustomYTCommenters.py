#This script is an almost identical copy of YoutubeCommenters.py. I am just using it to run scrape comments from specific channels of interest
import boto3
...
if __name__ == '__main__':
    ...
    youtube_channels = ['Stanz'] #Load list of 20k youtube channels
    channel_id_map = {'Stanz': 'UCpJZz0NtSgIdFhaXSPV4YqQ'}
